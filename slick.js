$(function() {
	...
	$('.blog-slider').slick({
		...
		slidesToScroll: 3,
		prevArrow:
			'<button type="button" class="prev-arrow slick-arrow" onclick="subtractWidth()"><i class="fal fa-arrow-left"></i></button>',
		nextArrow:
			'<button type="button" class="next-arrow slick-arrow" onclick="addWidth()";><i class="fal fa-arrow-right"></i></button>'
	});
